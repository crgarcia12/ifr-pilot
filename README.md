...
![IFR Pilot Game Screenshot](public/game-screenshot.svg)
...
- **Moving Map**: Zoomable and pannable with 8 zoom levels
- **Full Autopilot**: HDG, ALT, and IAS hold modes with v-speed control
- **Mission System**: Fly realistic routes like ROS → SNT → AEP ILS 13
